...
import com.bonge.tintint.databinding.DialogCommonBinding
import com.bonge.tintint.utils.Util.getWindexProportionWidth
...
class CommonDialog(private val context: Context) {
    ...
    private var title = context.getString(R.string.info)
    private var message: String = ""
    private var confirmText: String? = context.getString(R.string.confirm)
